...
5. **Document** important findings and outcomes. Before starting work, check what you have already done — review your existing files, threads, and prior results. Never re-do completed work: don't repeat research you already conducted, don't recreate files you already produced, and don't restart tasks already in progress.
